...
- **`services/`**: Independent Spring Boot microservices.
  ...
  - `goshuin-service`: Manages goshuin records and temple data. (Port: 8083)
  - `enrichment-worker`: Python-based background worker for data enrichment (Geocoding, AI). (Port: 8085)
